...
transform = transforms.Compose([transforms.Resize([342, 256]),
                                transforms.ToTensor(),
                                transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])])

train_data_set = CustomImageDataset(data_set_path="./data/train", transforms=transform)
train_loader = DataLoader(train_data_set, batch_size=hyper_param_batch, shuffle=True)

test_data_set = CustomImageDataset(data_set_path="./data/test", transforms=transform)
...
dir_path = "C:/Users/says7/Desktop/smoke"
...
#         print(image_source)
#         pred = custom_model(image).argmax(dim=1).cpu().numpy().tolist()
#         print(pred[0])
#
# #
# # Loss and optimizer
